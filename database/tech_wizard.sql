...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 18, 2024 at 07:17 AM
...
CREATE TABLE IF NOT EXISTS `consultations` (
  ...
  `scheduled_datetime` varchar(100) NOT NULL,
...
DROP TABLE IF EXISTS `interiordesign`;
CREATE TABLE IF NOT EXISTS `interiordesign` (
  ...
  `year_of_experiancre` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `product_categories` (
  `productCategories_id` int NOT NULL AUTO_INCREMENT,
